...
public class CustomNamespaceHandlerTest extends SpringHighlightingTestCase<JavaModuleFixtureBuilder> {
  ...
  public void testParseStringBean() throws Throwable {
    CommonSpringBean bean = parse("<stringBean xmlns=\"foo\" id=\"b1\"/>").getCustomBeans().get(0);
  ...
  public void testNoNamespaceHandler() throws Throwable {
    ...
    String[] expectedLines = expectedStackTrace.split("\n");
    String[] actualLines = trace.split("\n");
  ...
  public void testFilterOutInfrastructureBeans() throws Throwable {
    CommonSpringBean bean = assertOneElement(parse("<withInfrastructure xmlns=\"foo\" id=\"b1\"/>").getCustomBeans());
    assertEquals("b1", bean.getBeanName());
    assertEquals(CommonClassNames.JAVA_LANG_STRING, bean.getBeanClass().getQualifiedName());
  }

  public void testOnlyInfrastructureBeans() throws Throwable {
    XmlTag tag = createTag("<onlyInfrastructure xmlns=\"foo\" id=\"b1\"/>");
    CustomBeanRegistry.ParseResult result = CustomBeanRegistry.getInstance(myProject).parseBean(tag);
  ...
  public void testParseUtilMap() throws Throwable {
    CommonSpringBean bean = parse("<map xmlns=\"util\" id=\"mymap\"/>").getCustomBeans().get(0);
  ...
  public void testDontWaitTooLong() throws Throwable {
    ...
    try {
      CustomBeanWrapper bean = parse("<eternity xmlns=\"foo\"/>");
  ...
  public void testContextNamespaces() throws Throwable {
    XmlTag tag = createTag("<beans xmlns=\"http://www.springframework.org/schema/beans\" xmlns:foo=\"foo\"><foo:stringBean id=\"x\"/></beans>");
    CommonSpringBean bean = parse(tag.getSubTags()[0]).getCustomBeans().get(0);
    assertEquals("x", bean.getBeanName());
    assertEquals(CommonClassNames.JAVA_LANG_STRING, bean.getBeanClass().getQualifiedName());
  }

  public void testContextNamespaces2() throws Throwable {
    XmlTag tag = createTag("<beans:beans xmlns:beans=\"http://www.springframework.org/schema/beans\" xmlns=\"foo\"><stringBean id=\"x\"/></beans:beans>");
    CommonSpringBean bean = parse(tag.getSubTags()[0]).getCustomBeans().get(0);
    assertEquals("x", bean.getBeanName());
    assertEquals(CommonClassNames.JAVA_LANG_STRING, bean.getBeanClass().getQualifiedName());
  }
  ...
  public void testWithoutId() throws Throwable {
    CommonSpringBean bean = parse("<stringBean xmlns=\"foo\"/>").getCustomBeans().get(0);
    assertNull(bean.getBeanName());
    assertEquals(CommonClassNames.JAVA_LANG_STRING, bean.getBeanClass().getQualifiedName());
  }

  public void testFactoryBean15() throws Throwable {
    CommonSpringBean bean = parse("<factoryBean15 xmlns=\"foo\" id=\"foo\"/>").getCustomBeans().get(0);
  ...
  public void testFactoryBeanGenericMethod() throws Throwable {
    CommonSpringBean bean = parse("<genericMethod xmlns=\"foo\" id=\"foo\"/>").getCustomBeans().get(0);
  ...
  public void testAbstractFactoryBean() throws Throwable {
    CommonSpringBean bean = parse("<concreteFactoryBean xmlns=\"foo\" id=\"foo\"/>").getCustomBeans().get(0);
  ...
  public void testBeanPolicies() throws Throwable {
    ...
    XmlTag tag = createTag("<policyBean idd=\"239\" xmlns=\"foo\"/>");
    CustomBean bean = getWrapper(tag).getCustomBeans().get(0);
  ...
  public void testGetExceptionStackTrace() throws Throwable {
    XmlTag tag = createTag("<exception xmlns=\"foo\"/>");
    String stackTrace = CustomBeanRegistry.getInstance(myProject).parseBean(tag).getStackTrace();
  ...
  private CustomBeanWrapper getWrapper(XmlTag tag) {
