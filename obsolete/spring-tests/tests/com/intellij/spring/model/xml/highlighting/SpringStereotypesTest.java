...
public class SpringStereotypesTest extends SpringHighlightingTestCase<JavaModuleFixtureBuilder> {
  ...
  public void testStereotypesModel() throws Throwable {
    ...
    String[] strings = {"fooService1", "fooService2", "fooServiceGenre", "fooService4", "fooService5", "fooService6",
  ...
  public void testParentRef() throws Throwable {
    SpringFileSet parent = configureFileSet("parent", myModule);
    addFileToSet(parent, "parent.xml");

    SpringFileSet child = configureFileSet("child", myModule);
  ...
  public void testAutowiredMethod() throws Throwable {
    SpringFileSet set = configureFileSet();
  ...
  public void testAutowiredMethodGutter() throws Throwable {
    SpringFileSet set = configureFileSet();
    addFileToSet(set, "autowired.xml");
    GutterIconRenderer iconRenderer = myFixture.findGutter("components/AutowiredMethod.java");
    assertNotNull(iconRenderer);
    AnAction anAction = iconRenderer.getClickAction();
  ...
  public void testAutowiredFieldGutter() throws Throwable {
    SpringFileSet set = configureFileSet();
    addFileToSet(set, "autowired.xml");
    GutterIconRenderer iconRenderer = myFixture.findGutter("components/AutowiredField.java");
    assertNotNull(iconRenderer);
    AnAction anAction = iconRenderer.getClickAction();
    assertNotNull(anAction);
  }
  ...
  private Consumer<String>[] getConsumers(String[] strings) {
    List<Consumer<String>> list = ContainerUtil.map2List(strings, new Function<String, Consumer<String>>() {
  ...
  private List<String> getNames() {
    SpringModel model = SpringManager.getInstance(myProject).getAllModels(myModule).get(0);
